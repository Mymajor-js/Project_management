...
<body>
    ...
    <div class="content">
        ...
        <form action="{{ route('Mesave') }}" method="POST">
            @csrf
            <input type="hidden" name="my_name"class="d-none" value="{{Auth::user()->my_name}}" readonly>
            <input type="hidden" name="position"class="d-none" value="{{Auth::user()->my_name}}" readonly>
            ...
            <div class="form-group full-width">
                ...
                <div class="marginx">
                    <label>ชื่อผู้จัดทำโครงการ : {{Auth::user()->my_name}}</label>
                    <label>ตำแหน่ง : {{Auth::user()->position}}</label>
